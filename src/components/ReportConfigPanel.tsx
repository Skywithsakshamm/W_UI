    ...
    <div className="w-full bg-white dark:bg-[#0b162a] rounded-2xl border border-blue-900/20 dark:border-blue-500/20 shadow-sm transition-all p-5 sm:p-6">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-4 border-t border-neutral-200/80 dark:border-blue-900/40">
        ...
        <button
          ...
          className={`w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-7 py-3.5 rounded-xl font-bold text-sm sm:text-base transition-all shadow-md active:scale-95 ${
            canGenerate && !isProcessing
              ? 'bg-gradient-to-r from-blue-600 via-blue-500 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white shadow-blue-500/30 cursor-pointer hover:shadow-lg'
              : 'bg-neutral-200 dark:bg-blue-950/60 text-neutral-400 dark:text-blue-300/40 cursor-not-allowed shadow-none'
          }`}
        >
